		...
		<form action="MesFunctionFormulaire.php" method="GET">
			<p>	
				...
				<div>
					...
					<input type="text" id="prenom" name="prenom" value="<?php echo $liste['prenom'];  ?>">
				</div>
				<div>
					<label for="age">
						Age:
					</label>
					<input type="text" id="age" name="age" value="<?php echo $liste['age'];  ?>">
				</div>
				<div>
					<label for="age">
						sexe:
					</label>
					<input type="text" id="sexe" name="sexe" value="<?php echo $liste['sexe'];  ?>">
				</div>
				<div>
					<label for="adresse">
						adresse :
					</label>
					<textarea id="adresse" name="adresse" placeholder=<?php echo $liste['adresse'];  ?>></textarea>
				</div>
				<div class="button">
